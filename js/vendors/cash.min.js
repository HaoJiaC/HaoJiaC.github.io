! function(t, e) {
	"function" == typeof define && define.amd ? define(e) : "undefined" != typeof exports ? module.exports = e() : t
		.cash = t.$ = e()
}(this, function() {
	function t(e, n) {
	...
	d.init = function(e, n) {
		...
		if ("<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3) u = t.parseHTML(e);
			...
			n = t(n)[0] || s, u = a.call(l.test(r) ? f.test(e) ? s.getElementsByClassName(r) : s
				.getElementsByTagName(e) : n.querySelectorAll(e))
		}
		...
		return (t.matches || t.matchesSelector || t.msMatchesSelector || t.mozMatchesSelector || t
			.webkitMatchesSelector || t.oMatchesSelector).call(t, e)
	...
	d.extend({
		addClass: function(t) {
			...
			return this.each(function(t) {
				if (n = i.length, t.classList)
					...
					for (; n--;) e = " " + t.className + " ", -1 === e.indexOf(" " + i[n] +
						" ") && (t.className += " " + i[n])
			}), this
		},
		attr: function(t, e) {
		...
		hasClass: function(t) {
			return this[0].classList ? this[0].classList.contains(t) : -1 !== this[0].className.indexOf(
				t)
		},
		prop: function(t) {
			return this[0][t]
		...
		index: function(e) {
			return e ? a.call(t(e).children()).indexOf(this[0]) : a.call(t(this[0]).parent().children())
				.indexOf(this[0])
		},
		last: function() {
		...
		outerWidth: function(t) {
			return t === !0 ? this[0].offsetWidth + (n(this, "margin-left") || n(this, "marginLeft") ||
				0) + (n(this, "margin-right") || n(this, "marginRight") || 0) : this[0].offsetWidth
		},
		outerHeight: function(t) {
			return t === !0 ? this[0].offsetHeight + (n(this, "margin-top") || n(this, "marginTop") ||
					0) + (n(this, "margin-bottom") || n(this, "marginBottom") || 0) : this[0]
				.offsetHeight
		},
		width: function() {
		...
		off: function(e, n) {
			return this.each(function(i) {
				if (n) i.removeEventListener(e, n);
					...
					for (var r in p[t(i).data("cshid")][e]) i.removeEventListener(e, p[t(i)
						.data("cshid")][e][r])
			}), this
		},
		on: function(e, n, i) {
	...
	return d.extend({
			...
			for (e = i.elements.length - 1; e >= 0; e--)
				if (t = i.elements[e], t.name && "file" !== t.type && "reset" !== t.type)
					if ("select-multiple" === t.type)
						for (n = i.elements[e].options.length - 1; n >= 0; n--) t.options[n].selected &&
							(r += "&" + t.name + "=" + g(t.options[n].value).replace(/%20/g, "+"));
					else "submit" !== t.type && "button" !== t.type && (r += "&" + t.name + "=" + g(t
						.value).replace(/%20/g, "+"));
			return r.substr(1)
		},
		val: function(t) {
		...
		html: function(e) {
			var n;
			return "undefined" === e ? this[0].innerHTML : (n = "object" == typeof e ? t(e)[0]
				.outerHTML : e, this.each(function(t) {
		...
		is: function(e) {
			return e ? e.cash ? this[0] === e[0] : "string" == typeof e ? t.matches(this[0], e) : !1 : !
				1
		},
		find: function(e) {
		...
		parents: function(e) {
			...
			return this.each(function(u) {
				for (n = u; n !== s.body.parentNode;) n = n.parentElement, (!e || e && t
					.matches(n, e)) && (i[r] = n, r++)
			}), t.unique(i)
		},
		prev: function() {
